...
class SiteMapGenerator {
     ...
     *
     * @param string $site the URL of the site that you want to generate 
	 	the sitemap
     * @param bool $navigate if you want the SiteMapGenerator to already 
	 	start navigating through the site, default=true
     */
	...
	$xml = new SiteMapGenerator("www.acc.infoamper.com");
	
	$xml->getLinks();
	echo $xml->generateSiteMap();
